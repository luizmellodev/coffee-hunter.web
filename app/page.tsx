...
export default function Home() {
  return (
    <div className="min-h-screen">
        ...
        <div className="container relative">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    asChild
                    size="lg"
                    className="bg-gradient-to-r from-coffee-700 to-coffee-800 hover:from-coffee-800 hover:to-coffee-900 dark:from-coffee-300 dark:to-coffee-200 dark:text-coffee-900 text-white border-0 rounded-full px-8 py-6 text-lg group"
                  >
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="glass-effect border-0 rounded-full px-8 py-6 text-lg group hover:bg-accent/50"
                  >
                    <Link href="/metodos/espresso">
                      <Coffee className="mr-2 h-5 w-5 group-hover:scale-110 transition-transform" />
                      Ver Métodos
              ...
              <div className="relative animate-fade-in mr-40">
                <LottieAnimation
                  animation="catcoffee"
                  width={440}
                  height={440}
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <InfoCard
              ...
              icon={
                <Award className="h-8 w-8 text-coffee-700 dark:text-coffee-300" />
              }
            >
            ...
            <InfoCard
              ...
              icon={
                <Coffee className="h-8 w-8 text-coffee-700 dark:text-coffee-300" />
              }
            >
              <div className="space-y-3">
                <Link
            ...
            <InfoCard
              ...
              icon={
                <Users className="h-8 w-8 text-coffee-700 dark:text-coffee-300" />
              }
            >
              <div className="pt-4">
                <Button
      ...
      {/* Stats Section */}
      <section className="py-24 md:py-32 bg-gradient-to-r from-coffee-900 via-coffee-800 to-coffee-900 dark:from-black dark:via-coffee-950 dark:to-black text-white">
        <div className="container">
          <div className="grid md:grid-cols-4 gap-12 text-center">
            <div className="animate-fade-in">
              <div className="text-5xl md:text-6xl font-serif font-bold mb-4 text-gold-300">
                50+
              </div>
              <div className="text-white/80 text-lg">Métodos de Preparo</div>
            </div>
            <div className="animate-fade-in">
              <div className="text-5xl md:text-6xl font-serif font-bold mb-4 text-gold-300">
                100+
              </div>
              <div className="text-white/80 text-lg">Variedades de Café</div>
            </div>
            <div className="animate-fade-in">
              <div className="text-5xl md:text-6xl font-serif font-bold mb-4 text-gold-300">
                25+
              </div>
              <div className="text-white/80 text-lg">Países Produtores</div>
            </div>
            <div className="animate-fade-in">
              <div className="text-5xl md:text-6xl font-serif font-bold mb-4 text-gold-300">
                ∞
