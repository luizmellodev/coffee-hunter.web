...
export default function EspressoPage() {
  const espressoSteps = [
    ...
    },
    {
      title: "Tamping",
      description:
        "Tampe com pressão consistente de aproximadamente 15kg, mantendo o tamper nivelado.",
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold text-[#884A39] dark:text-white dark:text-white mb-6">
                O Coração do Café Especial
              </h2>
              <div className="space-y-4 text-[#884A39] dark:text-white dark:text-white dark:text-white">
                <p>
                  O espresso é a base de praticamente todas as bebidas de café
                  especial. Esta técnica italiana de extração utiliza água
                  quente sob alta pressão (9 bar) para extrair os compostos
                  solúveis do café moído fino em aproximadamente 25-30 segundos.
                </p>
                <p>
                  O resultado é uma bebida concentrada de 25-35ml, com crema
                  dourada característica, corpo aveludado e perfil sensorial
                  intenso que revela todas as nuances do grão utilizado.
                </p>
                <p>
                  Dominar o espresso requer compreensão das variáveis de
                  extração: dose, moagem, tempo, temperatura e pressão. Pequenos
                  ajustes em qualquer uma dessas variáveis podem transformar
          ...
          <div className="bg-white dark:bg-gray-950 dark:bg-stone-900 rounded-2xl p-8 shadow-md mb-16">
            <h3 className="text-2xl font-bold text-[#884A39] dark:text-white dark:text-white mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-950 dark:bg-stone-900 p-6 rounded-xl shadow-md">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="bg-[#F9E0BB] p-2 rounded-full">
                    <Coffee className="h-4 w-4 text-[#C38154]" />
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-[#884A39] dark:text-white dark:text-white">
                      Máquina com controle de temperatura e pressão estáveis.
                      Modelos semi-automáticos oferecem melhor controle para
                      iniciantes.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#884A39] dark:text-white dark:text-white">
                      Moedor de rebarbas com ajuste fino de granulometria. A
                      consistência da moagem é crucial para extrações uniformes.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#884A39] dark:text-white dark:text-white">
                      Balança com precisão de 0,1g para dosagem exata do café e
                      medição do yield final.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#884A39] dark:text-white dark:text-white">
                      Tamper com diâmetro exato do porta-filtro e base plana
                      para compactação uniforme.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-3 bg-red-50 border-l-4 border-red-400 rounded">
                  ...
                  <p className="text-sm text-red-700">
                    Moagem muito grossa ou dose insuficiente. Ajuste para moagem
                    mais fina ou aumente a dose.
                  </p>
                </div>
                <div className="p-3 bg-yellow-50 border-l-4 border-yellow-400 rounded">
                  ...
                  <p className="text-sm text-yellow-700">
                    Moagem muito fina ou dose excessiva. Ajuste para moagem mais
                    grossa ou reduza a dose.
                  </p>
                </div>
                <div className="p-3 bg-blue-50 border-l-4 border-blue-400 rounded">
                  <h4 className="font-medium text-blue-800">
                    Crema pálida ou ausente
                  </h4>
                  <p className="text-sm text-blue-700">
                    Café muito velho, moagem inadequada ou temperatura baixa.
                    Use café fresco e ajuste parâmetros.
                  </p>
                </div>
                <div className="p-3 bg-purple-50 border-l-4 border-purple-400 rounded">
                  <h4 className="font-medium text-purple-800">
                    Sabor amargo excessivo
                  </h4>
                  <p className="text-sm text-purple-700">
                    Sobre-extração. Reduza tempo, temperatura ou use moagem mais
                    grossa.
                  </p>
                </div>
              </div>
